...
// class MenuTab {
//   constructor (menuImg, menuName, menuDescrm, menuPrice, menuGr, parentElem) {
//     this.menuImg =  menuImg;
//     this.menuName = menuName;
//     this.menuDescrm = menuDescrm;
...
//       elem.innerHTML = `<div class="products-items">
//       div class="products-item">
//       <div class="products-item-image">
//         <img src="${menuImg}" alt="burger 1">
//       </div>
//       <div class="products-item-title">${menuName}</div>
//       <div class="products-item-text">${menuDescrm}</div>
//       <div class="products-item-extra">
//         <div class="products-item-info">
//           <div class="products-item-price">${menuPrice} $</div>
//           <div class="products-item-weight">${menuGr} гр</div>
//         </div>
...
class NewMenu {
  ...
  render (){
    ...
    element.innerHTML = `
      <div class="products-item">
      <div class="products-item-image">
        <img src="${this.menuImg}" alt="burger 1">
      </div>
      <div class="products-item-title">${this.menuName}</div>
      <div class="products-item-text">${this.menuDescrm}</div>
      <div class="products-item-extra">
        <div class="products-item-info">
          <div class="products-item-price">${this.menuPrice} $</div>
          <div class="products-item-weight">${this.menuGr} гр</div>
        </div>
        <div class="products-item-action">
          <button class='button product-button'>
            <span>Заказать</span>
...
new NewMenu ('images/1.png',
'Бургер чеддер & бекон',
'Котлета из говядины криспи, булочка, томат, сыр Чеддер, грудинка, лук красный,салат айсбер, майонез, кетчуп, сырный соус',
'8',
'360',
'.products .products-items').render();
new NewMenu ('images/2.png',
